 ...
 * @param  $ten_loai là tên loại mới
 ...
 * @param  $ma_loai là mã loại hoặc mảng mã loại
...
function loai_select_all_desc()
{
    $sql = "SELECT * FROM loai order by stt desc";
    return pdo_query($sql);
}
/**
