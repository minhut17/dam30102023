    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div>
                   Mật Khẩu<br>
                    <input class="form-control" name="password" class="form-control" type="password">
                    <br>
                </div>
                <div>
                  Địa chỉ email<br>
                    <input class="form-control" name="email" class="form-control" type="email">
                    <br>
                </div>
                <div>
            ...
            <div class="col-md-6">
                ...
                <div> Hình Ảnh <br>
                    <input class="form-control" name="thumbnail" type="file"><br>
                </div>
                <div>
        ...
        <div class="row m-3  ">
                    <div class="col text-center">
                        <a href=""><input class="btn btn-primary" type="submit" name="subkh" value="Thêm Mới"></a>
        ...
        <div class="row">
        <?php 
        if(isset($khthanhcong)){
           echo '<h2>'.$khthanhcong.'</h2>' ; 
        }
